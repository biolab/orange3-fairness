...
# class OWWeightedLogisticRegression(OWLogisticRegression):
...
class OWWeightedLogisticRegression(OWBaseLearner):
    name = "Weighted Logistic Regression"
    description = "The logistic regression classification algorithm modification with " \
                  "LASSO (L1) or ridge (L2) regularization. The modification allows for " \
                  "usage of instance weights in the training and prediction process."
    keywords = "weighted logistic regression"
